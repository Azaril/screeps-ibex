...
- **Status:** Accepted (2026-07-07, William Archbell — implement P0; deferred refinements R1–R4 additive). Supersedes the interim `forming_completion_bid(present, ticks)` escalation (ADR 0040 spawn lane, committed but band-scaled).
- **Date:** 2026-07-07
