# screeps-server-kit — preserved internal design notes

> Snapshot of the pre-extraction `README.md` for `screeps-server-kit`, preserved when the crate
> was extracted to https://github.com/Azaril/screeps-server-kit with an external-facing README.
