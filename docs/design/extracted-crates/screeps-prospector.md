# screeps-prospector — preserved internal design notes

> Snapshot of the pre-extraction `README.md` for `screeps-prospector`, preserved when the crate
> was extracted to https://github.com/Azaril/screeps-prospector with an external-facing README.
