# screeps-rest-api — preserved internal design notes

> Snapshot of the pre-extraction `README.md` for `screeps-rest-api`, preserved when the crate
> was extracted to https://github.com/Azaril/screeps-rest-api with an external-facing README.
