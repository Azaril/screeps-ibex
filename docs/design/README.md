...
| [0019](0019-combat-position-selection.md) | Unified combat position-selection: one objective-aware integer per-tile utility (flee/stand/close emerge as argmax) over two shared maps — integer threat field + multi-source reachability flood-fill — + 5 hard guards. Subsumes U8 kiting + T-POS attack-positioning. Staged/flagged, no WFV bump. | combat overhaul; 11-agent deep-dive 2026-06-19; generalizes 0008 §5 / 0008a T-POS | Proposed (Stage 0+1 awaiting operator) |
