...
| [0022](0022-combat-mmo-v1-roadmap.md) | Combat → MMO v1 end-state roadmap (operator re-plan): stop incremental deferrals; prove movement/objectives/identity/sizing BEFORE the first combat soak. Phases P0→P-MOVE→P-OBJ→P-ID→P-SPAWN→P-CORE→P-SOAK→P-DEPLOY→P5. Decisions D1–D15 (SquadId=Entity, curated comp library, cumulative-siege+R-attack in v1, retask re-runs the oracle, winnable cores HIGH+light-preempt). Single loud reset (WFV 16→17 at P-ID). Reconciles all outstanding combat work. | operator directive 2026-06-23; 7-agent reconciliation + interview; supersedes 0020 §10–§12 sequencing | **Accepted** |
