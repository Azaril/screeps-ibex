...
- 2026-08-23 — P3 landed dark (`2fd8253`+`82f2e83`). REMAINING before activation: (1) the O4 market-fed valuation (constants OK for first light), (2) an offline/live shakedown of the apply loop — flip `boost_military` on live once T-stock exists at one home and watch one boosted squad end-to-end (the P1 validation), (3) P4 sweep. ACTIVATION NOTE: flipping the flag while labs hold the autonomous 10k brew makes the offense clamp fire immediately — do it deliberately, watching.
