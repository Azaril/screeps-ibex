...
- **⚠ As of 2026-07-01 this plan is HISTORICAL — it is NOT the source of truth for combat/war status.** It is frozen at the 2026-06-19 / WFV-14 era; the combat program has since moved through ADR [0022](../design/0022-combat-mmo-v1-roadmap.md) (which superseded this doc's sequencing) and the ADR 0025–0038 wave, and the bot is at **WFV 24** and deployed to MMO. **Current status and the open-work backlog live in [`../execution/implementation-tracker.md`](../execution/implementation-tracker.md)** (the living master doc, 2026-08-22 onward); per-ADR ledgers in [`../design/`](../design/) remain authoritative for design rationale. ⚠ Several items this doc lists as open are verified CLOSED — W3 escort, K2c-2, U-TOWER, the whole G workstream; see the tracker §9 before acting on §3 or §5 here. Landed-task detail (commit SHAs, per-task validation cells) remains in [`../execution/phase-2.md`](../execution/phase-2.md); design rationale in ADR [0008](../design/0008-combat-and-squad-architecture.md) (+ tactics annex [0008a](../design/0008a-combat-tactics.md)). The body below is preserved as history: the obviously-overtaken sections carry `[OVERTAKEN — …]` annotations; the verified-still-true residue is §0a.
