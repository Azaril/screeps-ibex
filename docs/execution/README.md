...
| [`phase-2.md`](phase-2.md) | Combat-Effective (Inc 3–5 + combat-sim addition): combat micro-sim harness, SquadStore/SquadId, the anchor mover (footprint pathfind + orientation), CombatObjectiveQueue + SquadManager + tactics, war supervision + escort + thin posture hook, synchronized spawning → M4. Checkpoints CP-H/I/M/G/W/S are the resume points. | Not started |
