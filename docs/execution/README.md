...
| File | Purpose | Status |
|---|---|---|
| [`phase-0.md`](phase-0.md) | Baseline tooling (`screeps-eval` harness), host test lane + pin tests, supplanted-code cleanup, critical fixes (proposed-fixes Group A). Precedes all ADR increment work. | Active |
