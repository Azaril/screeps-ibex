...
pub fn quad_member_body(max_energy: u32) -> SpawnBodyDefinition<'static> {
    SpawnBodyDefinition {
        ...
        pre_body: &[Part::Tough, Part::Tough, Part::Tough, Part::Tough],
        repeat_body: &[Part::RangedAttack, Part::Move, Part::Heal, Part::Move],
        post_body: &[Part::Heal, Part::Heal, Part::Heal, Part::Heal, Part::Move, Part::Move, Part::Move, Part::Move],
    }
}
...
pub fn tank_body(max_energy: u32) -> SpawnBodyDefinition<'static> {
    SpawnBodyDefinition {
        ...
        maximum_repeat: None,
        pre_body: &[
            Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough,
        ],
        repeat_body: &[Part::Attack, Part::Move],
...
pub fn boosted_quad_member_body(max_energy: u32) -> SpawnBodyDefinition<'static> {
    SpawnBodyDefinition {
        ...
        post_body: &[Part::Heal, Part::Heal, Part::Heal, Part::Heal, Part::Heal, Part::Heal, Part::Move, Part::Move, Part::Move, Part::Move],
    }
}
...
pub fn boosted_duo_healer_body(max_energy: u32) -> SpawnBodyDefinition<'static> {
    SpawnBodyDefinition {
        ...
        minimum_repeat: Some(2),
        maximum_repeat: None,
        pre_body: &[Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough],
...
pub fn boosted_tank_body(max_energy: u32) -> SpawnBodyDefinition<'static> {
    SpawnBodyDefinition {
        ...
        maximum_repeat: None,
        pre_body: &[
            Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough,
            Part::Tough, Part::Tough, Part::Tough, Part::Tough, Part::Tough,
            Part::Tough, Part::Tough,
        ],
