...
pub fn arms(consts: MarketConsts, measure_gap: bool, oracle_period: u32) -> Vec<Arm> {
    vec![
        ...
        Arm {
            name: "market-k4off",
            cfg: PolicyConfig::market(MarketArmCfg { consts, k4_bodies: false, measure_gap: false, oracle_period, a3_live_control: false }),
        },
        ...
        Arm {
            name: "market",
            cfg: PolicyConfig::market(MarketArmCfg { consts, k4_bodies: true, measure_gap, oracle_period, a3_live_control: false }),
        },
        ...
        Arm {
            ...
            cfg: PolicyConfig::market(MarketArmCfg { consts, k4_bodies: true, measure_gap: false, oracle_period, a3_live_control: true }),
        },
    ]
}
...
pub fn evaluate_point(
    ...
    let arm = Arm {
        name: "market",
        cfg: PolicyConfig::market(MarketArmCfg { consts: consts_point, k4_bodies: true, measure_gap: false, oracle_period: 25, a3_live_control: false }),
    };
...
mod tests {
    ...
    fn end_state_market() -> PolicyConfig {
        PolicyConfig::market(MarketArmCfg { consts: MarketConsts::default(), k4_bodies: true, measure_gap: false, oracle_period: 25, a3_live_control: false })
    }
